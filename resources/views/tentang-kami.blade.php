...
<body class="font-sans text-gray-800 antialiased bg-white">
    ...
    <nav class="bg-[#fafafa] px-8 py-5 flex items-center justify-between border-b border-gray-200">
        ...
        <div class="hidden md:flex items-center gap-8 text-[13px] font-semibold text-gray-500">
            ...
            <a href="#" class="text-brand-green border-b-2 border-brand-green pb-1">Tentang Kami</a>
            <a href="#" class="hover:text-brand-green transition">Kontak</a>
        </div>

        <!-- Auth Buttons -->
        <div class="flex items-center gap-6 text-[13px] font-semibold">
            <a href="#" class="text-gray-500 hover:text-brand-green">Login</a>
            <a href="#" class="bg-brand-green text-white px-5 py-2 rounded hover:bg-green-800 transition">Daftar</a>
        </div>
    </nav>
    ...
    <header class="relative bg-gray-900 h-[450px] flex flex-col items-center justify-center text-center px-4">
        ...
        <div class="relative z-10 max-w-2xl text-white">
            <h2 class="text-sm font-medium mb-4 tracking-wide">Adventure Starts With The Right Gear</h2>
            <p class="text-sm md:text-[15px] leading-relaxed font-light text-gray-200">
                Twenty Nine Adventure is your trusted partner for high-quality outdoor equipment rental and sales. We provide reliable gear for weekend explorers and serious enthusiasts, ensuring every journey is safe and memorable.
            </p>
        </div>
    </header>
    ...
    <section class="py-20 px-8 max-w-5xl mx-auto">
        <div class="text-center mb-12">
            <h2 class="text-2xl font-bold text-gray-900 mb-3">Why Choose Us</h2>
            <p class="text-[13px] text-gray-500 max-w-xl mx-auto leading-relaxed">Discover the foundational pillars that make Twenty Nine Adventure the premier choice for your outdoor equipment needs.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="border border-gray-200 rounded-lg p-8 shadow-sm">
                ...
                <p class="text-gray-500 text-[13px] leading-relaxed">Located at the heart of your adventure routes, offering easy pickup and drop-off to streamline your journey.</p>
            </div>
            ...
            <div class="border border-gray-200 rounded-lg p-8 shadow-sm">
                ...
                <p class="text-gray-500 text-[13px] leading-relaxed">Expert advice and friendly service from outdoor enthusiasts who understand exactly what you need for a successful trip.</p>
            </div>
            ...
            <div class="border border-gray-200 rounded-lg p-8 shadow-sm">
                ...
                <p class="text-gray-500 text-[13px] leading-relaxed">We stock only high-quality, meticulously maintained gear from top brands to ensure reliability in any condition.</p>
            </div>
            ...
            <div class="border border-gray-200 rounded-lg p-8 shadow-sm">
                ...
                <p class="text-gray-500 text-[13px] leading-relaxed">Flexible delivery options available to bring the gear straight to your doorstep or basecamp, saving you valuable time.</p>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-[#ebebeb] py-10 px-8 border-t border-gray-200">
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <p class="text-[12px] text-gray-500">Address: Pakintelan, Gunung Pati</p>
            </div>
